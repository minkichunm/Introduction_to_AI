...
public class ValidMovesCalculator {
	...
	public byte getNextOpponent(){
		byte nextOpponent = (byte) (turnOfPlayer + 1);
		if (this.nOfPlayers < nextOpponent) {
			nextOpponent = 1;
		}
		return nextOpponent;
	}
	...
	public void decreaseTurnOfPlayer() {
		turnOfPlayer--;
		totalTurns--;
		if (1 > turnOfPlayer) {
			turnOfPlayer = nOfPlayers;
		}
	}
